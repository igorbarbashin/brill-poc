...
async function main() {
  ...
  renderer = new WebGLRenderer({ canvas: canvas, context: gl, antialias: true });
  ...
  diamond.meshes = {};
  diamond.uniforms = {
    color: { value: new Color(233, 245, 255) },//fixme properly bind threecolor to datgui
    ...
    chroma: { value: 0.23, minmax: [-1, 1], lambda: x => sin(x * x * x * PI) },
